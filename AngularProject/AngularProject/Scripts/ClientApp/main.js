...
const routes = [
    ...
    { path: 'notfound', component: _notfound_notfound_component__WEBPACK_IMPORTED_MODULE_6__["NotfoundComponent"] },
    { path: 'admin', loadChildren: () => __webpack_require__.e(/*! import() | Areas-admin-admin-module */ "Areas-admin-admin-module").then(__webpack_require__.bind(null, /*! ./Areas/admin/admin.module */ "./src/app/Areas/admin/admin.module.ts")).then(m => m.AdminModule) },
